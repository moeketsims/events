...
values
 ('bbbbbbbb-0000-0000-0000-00000000000a','00000000-0000-0000-0000-000000000000','authenticated','authenticated','organiser@demo.cut-events.test','', now(), now(), now(), '{}','{}'),
 ('bbbbbbbb-0000-0000-0000-00000000000b','00000000-0000-0000-0000-000000000000','authenticated','authenticated','door@demo.cut-events.test','', now(), now(), now(), '{}','{}'),
 ('bbbbbbbb-0000-0000-0000-00000000000c','00000000-0000-0000-0000-000000000000','authenticated','authenticated','other@demo.cut-events.test','', now(), now(), now(), '{}','{}')
on conflict (id) do nothing;
